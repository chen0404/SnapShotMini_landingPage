...
export const faqItems = [
  {
    question: "SnapShotMini 是什麼？",
    answer:
      "SnapShotMini 是約 30 × 30 × 30 公分的桌上型拍貼機，可在店內完成選相框、拍照、選照片、現場列印與掃碼取得電子檔。",
  },
  {
    question: "哪些店家或活動適合使用？",
    answer:
      "適合希望提供品牌拍貼體驗的咖啡廳、文創店、品牌連鎖店與活動場域。實際擺放位置、操作動線與合作內容會依現場條件評估。",
  },
  {
    question: "哪些內容可以客製？",
    answer:
  ...
  },
  {
    question: "如何提出合作詢問？",
    answer:
      "可在本頁合作表單填寫店家或品牌名稱、聯絡資訊與初步需求。資料送出後，會由專人聯繫並確認適合的客製內容與合作方式。",
  },
] as const;
